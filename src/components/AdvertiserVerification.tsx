...
import { Globe, Link as LinkIcon, User, Mail, Building } from 'lucide-react';
...
const AdvertiserVerification: React.FC<AdvertiserVerificationProps> = ({ onVerified }) => {
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-4">Advertiser Verification</h1>
          <p className="text-gray-400">Complete verification to start creating campaigns</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <ul className="space-y-2 text-gray-300">
              <li>• Access to campaign creation tools</li>
              <li>• Verified advertiser badge</li>
